...
function getNewTravisConf(gaiaRoot, jobType, globals, repetitions) {
    ...
    try {
      fs.readFile(ymlFile, 'utf-8', function (err, data) {
        ...
        for (var i = 0; i < repetitions; i++) {
          config.env.matrix.push('CI-ACTION=' + jobType + ' TRY=' + i);
        }
...
// function createPullRequest(credentials, title, branchName) {
//   return Q.promise(function (resolve, reject) {
//     if (!credentials || !credentials.username || !credentials.password) {
//       reject('Credentials are mandatory');
//       return;
//     }
...
var GaiaCheckIntermitent = {
  ...
  pushTaskBranch: function (gaiaRoot, remote, jobType, globals, repetitions) {
    return Q.promise(function (resolve, reject) {
      ...
      getNewTravisConf(gaiaRoot, jobType, globals, repetitions).then(function (config) {        
...
var gaiaRoot = '/Users/arcturus/dev/git/community/gaia';
var remote = 'upstream_arcturus';
var job = 'marionette_js';
var globals = ['TEST_FILES=./apps/communications/contacts/test/marionette/delete_contacts_test.js'];
...
//   }
// );
// GaiaCheckIntermitent.createPullRequest({'username': 'arcturus', 'password': 'xyz'}, 'PR', 'marionette_js_1401386410445');
